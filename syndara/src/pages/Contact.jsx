            ...
            {formType === "borrower" ? (
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full px-6 py-3 bg-amber-500 hover:bg-amber-600 text-white rounded-lg font-medium inline-flex items-center justify-center transition-colors"
                >
                  Submit Scenario
                  <Send className="ml-2" />
                </button>
              ...
              <div className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label htmlFor="investor-name" className="block text-sm font-medium text-gray-700">
                      Full name
                    </label>
                    <input
                      id="investor-name"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="investor-email" className="block text-sm font-medium text-gray-700">
                      Email
                    </label>
                    <input
                      id="investor-email"
                ...
                <div className="space-y-2">
                  <label htmlFor="investor-message" className="block text-sm font-medium text-gray-700">
                    Message
                  </label>
                  <textarea
                    id="investor-message"
